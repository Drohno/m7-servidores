...
public class PostServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (validation.isValidAge(edat)) {
                out.println("<p>Tens" + edat + " anys i pots escriure un missatge a l'aplicació.</p>");
            } else {
            ...
            if (validation.isValidPost(missatge)) {
                out.println("<p>El missatge '" + missatge + "' és vàlid.</p>");
            } else {
