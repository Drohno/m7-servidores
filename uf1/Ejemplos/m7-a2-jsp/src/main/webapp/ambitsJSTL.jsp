...
<html>
    <head>
        <title>Àmbits de les variables a JSTL</title>
    </head>

    <body>
        <c:set var="test" value="Valor d'una variable d'àmbit de pàgina" scope="page" />
        ...
        <c:set var="test" value="Valor d'una variable d'àmbit d'aplicació"
               scope="application" />
        <h1>Àmbits de les variables a JSTL/JSP:</h1>
        <table border="1">
            <tr>
                <td>
                    <b>Àmbit per defecte: </b>
                </td>
                <td>
                    <c:out value="${test}" />
                </td>
